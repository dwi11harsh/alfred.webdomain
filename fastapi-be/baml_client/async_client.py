...
class BamlAsyncClient:
    ...
    async def PreprocessUserPrompt(self, user_prompt: str,
        ...
        if 'on_tick' in baml_options:
            ...
            return typing.cast(str, result.cast_to(types, types, stream_types, False, __runtime__))
    async def PromptBreakdownForNextGeneration(self, query: str,
        baml_options: BamlCallOptions = {},
    ) -> typing.List[str]:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="PromptBreakdownForNextGeneration", args={
                "query": query,
            })
...
class BamlStreamClient:
    ...
    def PromptBreakdownForNextGeneration(self, query: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="PromptBreakdownForNextGeneration", args={
            "query": query,
        })
...
class BamlHttpRequestClient:
    ...
    async def PromptBreakdownForNextGeneration(self, query: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="PromptBreakdownForNextGeneration", args={
            "query": query,
        }, mode="request")
        return result
